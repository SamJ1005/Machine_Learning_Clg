...
arr=np.round(np.linspace(0,1,10),3)
print(arr)
...
a=np.array(list(map(int, input("Enter 3 elements for array A: ").split())))
b=np.array(list(map(int, input("Enter 3 elements for array B: ").split())))
